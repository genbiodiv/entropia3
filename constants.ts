...
export const TRANSLATIONS = {
  es: {
    ...
    quote: "Explora la relación entre el orden local y la disipación de energía en este simulador de sistemas.",
    cycle: "Ciclo",
    of: "de",
    ...
    balanceSubtitle: "Resumen de la simulación",
    maxOrder: "Orden Máximo",
    entropy: "Entropía",
    analysisTitle: "Análisis de Datos",
    metricsConsolidated: "Métricas Finales",
    totalDissipation: "Energía Total Disipada",
    degradationRate: "Gasto de Energía por Ciclo",
    accumulatedOrder: "Orden Total Acumulado",
    reflectionQuote: "Has completado el ciclo de simulación con éxito.",
    reflectionDesc: "A través de tus decisiones, has logrado equilibrar la creación de estructuras y el consumo de energía. Revisa tus métricas finales para ver el impacto de tu estrategia en el sistema.",
  ...
  en: {
    ...
    quote: "Explore the relationship between local order and energy dissipation in this system simulator.",
    cycle: "Cycle",
    of: "of",
    ...
    balanceSubtitle: "Simulation summary",
    maxOrder: "Max Order",
    entropy: "Entropy",
    analysisTitle: "Data Analysis",
    metricsConsolidated: "Final Metrics",
    totalDissipation: "Total Energy Dissipated",
    degradationRate: "Energy Cost per Cycle",
    accumulatedOrder: "Total Accumulated Order",
    reflectionQuote: "You have successfully completed the simulation cycle.",
    reflectionDesc: "Through your decisions, you have balanced structure creation and energy consumption. Review your final metrics to see the impact of your strategy on the system.",
